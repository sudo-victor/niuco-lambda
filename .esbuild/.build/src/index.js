...
// src/domain/enterprise/email.ts
var Email = class _Email extends ValueObject {
  ...
  static create(email) {
    ...
    return new _Email(result);
  }
};

// src/domain/enterprise/is-enabled.ts
var IsEnabled = class _IsEnabled extends ValueObject {
  static create(status) {
    return new _IsEnabled(status === "enabled");
  }
};

// src/domain/enterprise/is-paying.ts
var IsPaying = class _IsPaying extends ValueObject {
  static create(role, status) {
    if (status === "disabled")
      return new _IsPaying(false);
    const payingRoles = ["editor", "admin"];
    return new _IsPaying(payingRoles.includes(role));
  }
};

// src/domain/enterprise/user.ts
...
// src/domain/application/list-users-usecase.ts
...
// src/external/user-gateway-saas-mock.ts
var UserGatewaySaasMock = class {
  async listUsers() {
    const response = await axios_default(`${process.env.API_URL}/users`);
    return response.data;
  }
};

// src/factory.ts
var MakeListUser = class {
  static make() {
